...
namespace MyInventory
{
    public class ItemDetailBindingProvider : BindingProvider
    {
        ...
        public ItemDetailBindingProvider()
        {
            ...
            this.AddBinding("IsSoldLabel", BindableProperties.TextProperty, "Item.IsSold");

            this.AddBinding("CloseButton", BindableProperties.CommandProperty, "CloseCommand");
            this.AddBinding("EditItem", BindableProperties.CommandProperty, "EditCommand");
            this.AddBinding("SoldItem", BindableProperties.CommandProperty, "SoldCommand");
        }
