...
namespace MyInventory.Models
{
    public class UserSettings : EntityBase
    {
        ...
        public static EntityProperty AutoRefreshPropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, bool>("AutoRefresh", false));

        public static EntityProperty EnableInAppSoundPropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, bool>("EnableInAppSound", false));

        public static EntityProperty EnableInAppVibratePropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, bool>("EnableInAppVibrate", false));

        public static EntityProperty EnableNotificationPropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, bool>("EnableNotification", false));

        public static EntityProperty SyncIntervalPropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, int>("SyncInterval", false));

        public static EntityProperty TextSizePropertyMetadata = EntityMetadata.Register(new DataEntityProperty<UserSettings, TextSize>("TextSize", false));
